...
import br.com.saudepraja.domain.service.user.CustomerService;
...
public class UserServiceTest {
    ...
    public void Dado_id_usuario_Quando_valido_Entao_exclua() throws Exception {
        Mockito.when(usersRepository.findById(anyLong())).thenReturn(Optional.of(users));
    ...
    public void Dado_criacao_usuario_Quando_informado_usuario_valido_Entao_cadastre() {
        UserDTO userDTO = userService.save(UserDTOMock.newUserDTO(10L, UserTypeEnum.CUSTOMER));
